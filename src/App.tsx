...
export function App() {
  ...
  return <div className="min-h-screen bg-gray-100">
      ...
      <header className="w-full bg-white flex items-center px-10 h-16 border-b border-gray-200 sticky top-0 z-50">
        ...
        <div className="portal-title text-lg font-bold text-blue-900 mr-auto">
        </div>
          ...
          <div className="mb-6 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2">
              <button 
                ...
                className="bg-blue-800 p-2 rounded-full hover:bg-blue-700 transition-colors text-white"
              >
